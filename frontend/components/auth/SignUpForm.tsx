...
import { Input, Button, Select, SelectItem, Checkbox, CheckboxGroup } from '@heroui/react';
    ...
    <>
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-5">
        ...
        <Select
          ...
          variant="bordered"
          selectedKeys={[role]}
          onChange={(e) => onRoleChange(e.target.value as 'Admin' | 'Student')}
          classNames={{ 
            trigger: "border-default-200 dark:border-default-100 hover:border-primary-400 dark:hover:border-primary-500" 
          }}
        >
            ...
            <div className="border-2 border-dashed border-default-200 dark:border-default-100 rounded-xl p-4 bg-default-50 dark:bg-default-50/5">
              ...
              >
                {POSSIBLE_NEEDS.map(need => (
                  <Checkbox key={need.id} value={need.id} classNames={{ label: "text-sm" }}>
                    {need.label}
                  </Checkbox>
                ))}
              </CheckboxGroup>
